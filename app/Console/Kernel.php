...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        \App\Console\Commands\CheckMissedPunchOut::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('comp-off:process')
                 ...
                 ->withoutOverlapping();
        $schedule->command('comp-off:consume-absences')
                 ->dailyAt('00:10') // Run at 12:10 AM every day
        ...
        // Check for missed punch-outs (>= 9 hours after punch in)
        $schedule->command('attendance:check-missed-punchout')
            ->everyTenMinutes()
            ->withoutOverlapping();
