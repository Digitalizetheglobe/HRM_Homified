...
use App\Http\Controllers\SalaryArrearsController;
use App\Http\Controllers\OtherDeductionController;
use App\Http\Controllers\PetrolAllowanceController;
...
Route::get('/run-recalculate-leaves', function () {
    \Illuminate\Support\Facades\Artisan::call('leaves:recalculate-balances');
    return 'Leave balances recalculated successfully! Output: ' . nl2br(\Illuminate\Support\Facades\Artisan::output());
});

// Serve company logo directly from storage (works on shared hosting without symlinks)
Route::get('/company-logo', function () {
    $paths = [
        storage_path('uploads/logo/dark-logo.png'),
        storage_path('uploads/logo/2_dark_logo.png'),
        storage_path('uploads/logo/logo-dark.png'),
        storage_path('app/public/uploads/logo/dark-logo.png'),
        storage_path('app/public/uploads/logo/2_dark_logo.png'),
    ];
...
// General storage proxy — serves ANY file from storage/uploads/ without symlinks
// Handles avatars, logos, documents, and all uploaded files on shared hosting (Hostinger hPanel)
Route::get('/storage/{path}', function ($path) {
    // Try storage/app/public first, then storage/ directly
    $candidates = [
...
Route::get('/reset-all-comp-offs', [\App\Http\Controllers\CompOffResetController::class, 'reset'])->middleware('auth');
Route::get('/process-comp-off-year', [\App\Http\Controllers\CompOffResetController::class, 'processYear'])->middleware('auth');
Route::post('/process-comp-off-year', [\App\Http\Controllers\CompOffResetController::class, 'processYear'])->name('comp-off.process-year')->middleware('auth');
// Automatic daily Comp-Off processing (for cron jobs - no auth required, uses token)
Route::get('/cron/process-comp-off-daily', [\App\Http\Controllers\CompOffResetController::class, 'processDaily'])->name('comp-off.process-daily');

Route::group(['middleware' => ['auth']], function () {
    Route::post('comp-off/normalize-year', [\App\Http\Controllers\CompOffNormalizationController::class, 'run'])
        ->name('comp-off.normalize-year')
    ...
    Route::get('comp-off-leaves', [LeaveController::class, 'compOffIndex'])->name('leave.compoff.index');
    Route::get('carry-forward-leaves', [LeaveController::class, 'carryforwardIndex'])->name('leave.carryforward');
});
...
Route::group(['middleware' => ['auth', 'verified']], function() {
    ...
    Route::group(['prefix' => 'salary-arrears', 'as' => 'salary-arrears.'], function() {
        Route::get('/', [SalaryArrearsController::class, 'index'])->name('index');
        Route::post('/store', [SalaryArrearsController::class, 'store'])->name('store');
        Route::get('/{id}/edit', [SalaryArrearsController::class, 'edit'])->name('edit');
        Route::put('/{id}', [SalaryArrearsController::class, 'update'])->name('update');
        Route::delete('/{id}', [SalaryArrearsController::class, 'destroy'])->name('destroy');
        Route::get('/employees', [SalaryArrearsController::class, 'getEmployees'])->name('employees');
    });

    // Other Deduction Routes
    Route::group(['prefix' => 'other-deduction', 'as' => 'other-deduction.'], function() {
        Route::get('/', [OtherDeductionController::class, 'index'])->name('index');
        Route::post('/store', [OtherDeductionController::class, 'store'])->name('store');
        Route::get('/{id}/edit', [OtherDeductionController::class, 'edit'])->name('edit');
        Route::put('/{id}', [OtherDeductionController::class, 'update'])->name('update');
        Route::delete('/{id}', [OtherDeductionController::class, 'destroy'])->name('destroy');
        Route::get('/employees', [OtherDeductionController::class, 'getEmployees'])->name('employees');
    });

    // Petrol Allowance Routes
    Route::group(['prefix' => 'petrol-allowance', 'as' => 'petrol-allowance.'], function() {
        Route::get('/', [PetrolAllowanceController::class, 'index'])->name('index');
        Route::post('/store', [PetrolAllowanceController::class, 'store'])->name('store');
        Route::delete('/{id}', [PetrolAllowanceController::class, 'destroy'])->name('destroy');
        Route::get('/employees', [PetrolAllowanceController::class, 'getEmployees'])->name('employees');
    });
});
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('employee/{id}/export-inactive-modal', [EmployeeController::class, 'exportInactiveModal'])->name('employee.export_inactive_modal');
    Route::post('employee/{id}/export-inactive', [EmployeeController::class, 'exportInactive'])->name('employee.export_inactive');
    ...
    Route::get('setsalary/popup/{id}', [SetSalaryController::class, 'salaryPopup'])->name('setsalary.popup')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('payable-days', [PaySlipController::class, 'payableDays'])->name('payable-days.index')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('payable-days/search_json', [PaySlipController::class, 'payableDaysSearch'])->name('payable-days.search_json')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('leave-details', [LeaveController::class, 'leaveDetails'])->name('leave.details')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('leave/{id}/reason', [LeaveController::class, 'reason'])->name('leave.reason')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('attendanceemployee/update-location', [AttendanceEmployeeController::class, 'updateLocation'])->name('attendanceemployee.update-location')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('attendanceemployee/update-location-from-ip', [AttendanceEmployeeController::class, 'updateLocationFromIP'])->name('attendanceemployee.update-location-from-ip')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('employee-tracking/simulate-ping', [\App\Http\Controllers\EmployeeTrackingController::class, 'simulatePing'])->name('employee.simulate-ping')->middleware(['auth', 'XSS']);
    ...
    Route::get('attendance-regularisation/get-employees', [\App\Http\Controllers\AttendanceRegularisationController::class, 'getEmployees'])->name('attendance-regularisation.getEmployees')->middleware(['auth', 'XSS']);
    Route::post('attendance-regularisation', [\App\Http\Controllers\AttendanceRegularisationController::class, 'store'])->name('attendance-regularisation.store')->middleware(['auth', 'XSS']);
    Route::get('attendance-regularisation/{id}/action', [\App\Http\Controllers\AttendanceRegularisationController::class, 'action'])->name('attendance-regularisation.action')->middleware(['auth', 'XSS']);
    Route::get('attendance-regularisation/{id}/edit', [\App\Http\Controllers\AttendanceRegularisationController::class, 'edit'])->name('attendance-regularisation.edit')->middleware(['auth', 'XSS']);
    Route::get('attendance-regularisation/{id}', [\App\Http\Controllers\AttendanceRegularisationController::class, 'show'])->name('attendance-regularisation.show')->middleware(['auth', 'XSS']);
    Route::put('attendance-regularisation/{id}', [\App\Http\Controllers\AttendanceRegularisationController::class, 'update'])->name('attendance-regularisation.update')->middleware(['auth', 'XSS']);
    Route::delete('attendance-regularisation/{id}', [\App\Http\Controllers\AttendanceRegularisationController::class, 'destroy'])->name('attendance-regularisation.destroy')->middleware(['auth', 'XSS']);
    Route::post('attendance-regularisation/changeaction', [\App\Http\Controllers\AttendanceRegularisationController::class, 'changeaction'])->name('attendance-regularisation.changeaction')->middleware(['auth', 'XSS']);
    Route::post('attendance-regularisation/{id}/approve', [\App\Http\Controllers\AttendanceRegularisationController::class, 'approve'])->name('attendance-regularisation.approve')->middleware(['auth', 'XSS']);
    Route::post('attendance-regularisation/{id}/reject', [\App\Http\Controllers\AttendanceRegularisationController::class, 'reject'])->name('attendance-regularisation.reject')->middleware(['auth', 'XSS']);
    ...
    Route::post('attendance-calendar/update', [AttendanceEmployeeController::class, 'updateCalendarAttendance'])->name('attendance.calendar.update')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('attendance/export', [AttendanceEmployeeController::class, 'export'])->name('attendance.export');
        ...
        Route::group(['middleware' => ['auth', 'XSS']], function() {
            ...
            Route::group(['prefix' => 'booking', 'as' => 'booking.'], function() {
                ...
                Route::get('/create', [BookingFormController::class, 'create'])->name('create');
                Route::get('/add', [BookingFormController::class, 'addBooking'])->name('add');
                Route::get('/all', [BookingFormController::class, 'index'])->name('all'); // Use the existing index method
                ...
                Route::get('/payslip/{id}', [BookingFormController::class, 'payslip'])->name('payslip');
                ...
                Route::get('/get-enquiries-by-project/{projectId}', [BookingFormController::class, 'getEnquiriesByProject'])
                    ->name('get.enquiries.by.project');

                Route::get('/projects/{project}/get-type', function(Project $project) {
                    return response()->json(['project_type' => $project->project_type]);
                     });

                Route::get('/edit-booking', [BookingFormController::class, 'editBooking'])->name('edit.booking');
                Route::post('/load-booking-data', [BookingFormController::class, 'loadBookingData'])->name('load.booking.data');
                Route::get('/booking/get-bookings-by-project/{projectId}', [BookingFormController::class, 'getBookingsByProject'])
                        ->name('booking.get.by.project');

                Route::put('/booking/{bookingForm}', [BookingFormController::class, 'update'])->name('booking.update');
                Route::post('/booking/{booking}', [BookingFormController::class, 'update']); // Some forms use POST with method spoofing


                Route::put('/booking/{bookingForm}/cancel', [BookingFormController::class, 'cancel'])
                    ->name('booking.cancel');

                Route::get('/booking/pdf/{id}', [BookingFormController::class, 'bookingFormPdf'])->name('booking.pdf');

                Route::get('/booking/print/{id}', [BookingFormController::class, 'print'])->name('booking.print');

                Route::get('booking-form/{id}/pdf', [BookingFormController::class, 'bookingFormPdf'])
                    ->name('booking.form.pdf');

                Route::post('/booking/{id}/mark-agreement-done', [BookingFormController::class, 'markAgreementDone'])
                    ->name('booking.mark.agreement.done');
    ...
    // Company Policy Acknowledgements (Company User) - Must be before resource route
    Route::get('company-policy/acknowledgements', [CompanyPolicyController::class, 'acknowledgements'])->name('company-policy.acknowledgements')->middleware(['auth', 'XSS']);
    ...
    // Company Policy Employee Routes
    Route::prefix('employee')->group(function () {
        Route::get('company-policy/preview/{id}', [CompanyPolicyController::class, 'preview'])->name('company-policy.employee.preview')->middleware(['auth', 'XSS']);
        Route::get('company-policy/download/{id}', [CompanyPolicyController::class, 'download'])->name('company-policy.employee.download')->middleware(['auth', 'XSS']);
        Route::get('company-policy/stream/{id}', [CompanyPolicyController::class, 'stream'])->name('company-policy.employee.stream')->middleware(['auth', 'XSS']);
        Route::post('company-policy/track-download/{id}', [CompanyPolicyController::class, 'trackDownloadAction'])->name('company-policy.employee.track-download')->middleware(['auth', 'XSS']);
    ...
    ->middleware(['auth', 'XSS']);
    Route::post('/notification/mark-all-read', [UserController::class, 'markAllRead'])->name('notification.markAllRead')->middleware(['auth', 'XSS']);
    ...
    Route::post('export/employee', [EmployeeController::class, 'export'])->name('employee.export_alt');
    ...
    Route::post('/hrm/check-half-day-availability', [LeaveController::class, 'checkHalfDayAvailability'])->name('check.half.day.availability');  
...
// ====== APK Download Route — forces proper binary download ======
Route::get('/download-apk', function () {
    $apkPath = public_path('RisingHRM.apk');
    ...
    return response()->download(
        ...
        [
            ...
            'Content-Disposition' => 'attachment; filename="RisingHRM.apk"',
...
Route::get('/test-whatsapp/{phone}', function($phone) {
    try {
        ...
        $message = "Test WhatsApp message from Rising Spaces HRM - " . date('Y-m-d H:i:s');
...
Route::get('/test-twilio-connection', function() {
    try {
        $sid = env('TWILIO_SID');
    ...
    Route::get('/employee-permissions', [EmployeePermissionController::class, 'index'])->name('employee-permissions.index');
    Route::post('/employee-permissions/fetch', [EmployeePermissionController::class, 'fetch'])->name('employee-permissions.fetch');
    Route::post('/employee-permissions/sync', [EmployeePermissionController::class, 'sync'])->name('employee-permissions.sync');
