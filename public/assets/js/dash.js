...
function addscroller() {
    rmmini();
    menuclick();
    // Menu scrollbar start — only use SimpleBar on desktop (>1024px).
    // On mobile, native -webkit-overflow-scrolling: touch is smoother.
    if (document.querySelector(".navbar-content") && window.innerWidth > 1024) {
...
function rmmenu() {
  ...
  var sideOverlay = document.querySelector(".dash-sidebar .dash-menu-overlay");
  if (sideOverlay) sideOverlay.remove();
  var topbarOverlay = document.querySelector(".topbar .dash-menu-overlay");
...
function rmovermenu() {
  ...
  var sideOverlay2 = document.querySelector(".dash-sidebar .dash-menu-overlay");
  if (sideOverlay2) sideOverlay2.remove();
  var topbarOverlay2 = document.querySelector(".topbar .dash-menu-overlay");
  if (topbarOverlay2) topbarOverlay2.remove();
}
