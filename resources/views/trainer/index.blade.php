...
@section('action-button')
    <a href="{{ route('trainer.export') }}" class="btn btn-sm btn-primary">
        <i class="ti ti-file-export"></i>
    </a>

    <a href="#" data-url="{{ route('trainer.file.import') }}" data-ajax-popup="true"
        data-title="{{ __('Import Trainer CSV file') }}" class="btn btn-sm btn-primary">
        <i class="ti ti-file-import"></i>
    </a>

    @can('Create Trainer')
        <a href="#" data-url="{{ route('trainer.create') }}" data-ajax-popup="true" data-size="lg"
            data-title="{{ __('Create New Trainer') }}" class="btn btn-sm btn-primary">
                                                ...
                                                @can('Show Trainer')
                                                    <div class="action-btn bg-warning ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-size="lg"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Trainer Details') }}">
                                                ...
                                                @can('Edit Trainer')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-size="lg"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Trainer') }}">
