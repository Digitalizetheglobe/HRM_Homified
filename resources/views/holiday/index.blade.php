...
@section('action-button')
    <a href="{{ route('holidays.export') }}" class="btn btn-sm btn-primary">
    ...
    <a href="{{ route('holiday.calender') }}" class="btn btn-sm btn-primary">
                                                ...
                                                @can('Edit Holiday')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Holiday') }}">
