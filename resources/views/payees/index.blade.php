...
@section('action-button')
    @can('Create Payee')
        <a href="#" data-url="{{ route('payees.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Payee') }}" class="btn btn-sm btn-primary">
                                                ...
                                                @can('Edit Payee')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Payee') }}">
