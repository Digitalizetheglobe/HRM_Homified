                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-md-1">
                                                                    <div class="form-group cursor-pointer">
                                                                        <a class="text-muted" data-from="banktransfer"><i
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stripe-peyment-div">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-md-1">
                                                                        <div class="form-group cursor-pointer">
                                                                            <a class="text-muted" data-from="stripe"><i
                                                            ...
                                                            <div class="col-md-1">
                                                                {{-- <div class="form-group apply-paypal-btn-coupon">
                                                                    <a href="#" data-from="paypal"
                                                                        class="btn btn-sm btn-primary apply-coupon"><i
                                                    ...
                                                    <div class="paystack-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="paystack"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-1">
                                                            ...
                                                            <div class="form-group cursor-pointer">
                                                                <a class="text-muted" data-from="flaterwave"><i
                                                                        class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="razorpay-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="razorpay"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="paytm-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1 mt-5">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="paytm"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="mercado-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="mercado"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="mollie-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="mollie"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="skrill-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="skrill"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="coingate"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="py-3 paymentwall-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="paymentwall"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="py-3 iyzipay-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="iyzipay"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="py-3 sspay-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="sspay"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="py-3 paytab-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="paytab"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="py-3 benefit-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="benefit"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="py-3 cashfree-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="cashfree"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="py-3 aamarpay-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="aamarpay"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="py-3 yookassa-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="yookassa"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="py-3 midtrans-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="midtrans"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="py-3 xendit-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="xendit"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="py-3 nepalste-payment-div">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="nepalste"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="py-3 paiementpro-payment-div">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-1 mt-4">
                                                                <div class="form-group cursor-pointer">
                                                                    <a class="text-muted" data-from="paiementpro"><i
                                                                            class="ti ti-square-check btn-apply apply-coupon"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
