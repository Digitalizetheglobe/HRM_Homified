...
@section('action-button')
    @can('Create Role')
        <a href="#" data-url="{{ route('roles.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Role') }}" data-size="lg" class="btn btn-sm btn-primary">
                                                ...
                                                @can('Edit Role')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-size="lg" data-title="{{ __('Edit Role') }}">
