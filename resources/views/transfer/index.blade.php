...
@section('action-button')
    @can('Create Transfer')
        <a href="#" data-url="{{ route('transfer.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create New Transfer') }}" data-size="lg"
                        ...
                        <table class="table" id="pc-dt-simple">
                            ...
                            <tbody class="">
                                ...
                                @foreach ($transfers as $transfer)
                                    <tr>
                                        @role('company')
                                            <td>{{ !empty($transfer->employee_id) ? $transfer->employee->full_name : '' }}</td>
                                        @endrole
                                                    ...
                                                    @can('Edit Transfer')
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                                ...
                                                                data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Transfer') }}">
