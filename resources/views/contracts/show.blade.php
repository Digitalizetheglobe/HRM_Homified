        ...
        @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'hr')
            ...
            @can('Create Contract')
                ...
                <a href="#" data-size="lg" data-url="{{ route('contracts.copy', $contract->id) }}"data-ajax-popup="true"
                    data-title="{{ __('Duplicate') }}" class="btn btn-sm btn-primary btn-icon m-2"><i class="ti ti-copy text-white"></i></a>
            @endcan
        @endif

        {{-- @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'employee') --}}
        <a href="{{ route('contract.download.pdf', \Crypt::encrypt($contract->id)) }}"
            class="btn btn-sm btn-primary btn-icon m-2" target="_blanks"><i class="ti ti-download text-white"></i></a>
        {{-- @endif --}}
        ...
        {{-- @if ((\Auth::user()->type == 'company' && $contract->company_signature == '') || (\Auth::user()->type == 'employee' && $contract->employee_signature == ''))
            @if ($contract->status == 'accept')
                <a href="#" class="btn btn-sm btn-primary btn-icon m-2"
                    ...
                    data-title="{{ __('Signature') }}" data-size="md">
                                        ...
                                        <div class="card-body pt-0 ">
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-8 text-sm"> {{ $contract->employee->full_name }}</div>
