...
@section('action-button')
    @can('Create Promotion')
        <a href="#" data-url="{{ route('promotion.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create New Promotion') }}" data-size="lg"
                    ...
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            @foreach ($promotions as $promotion)
                                <tr>
                                    @role('company')
                                        <td>{{ !empty($promotion->employee_id) ? $promotion->employee->full_name : '' }}</td>
                                    @endrole
                                                ...
                                                @can('Edit Promotion')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-size="lg"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Promotion') }}">
