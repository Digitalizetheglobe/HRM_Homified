...
@section('action-button')
    @can('Create Payer')
        <a href="#" data-url="{{ route('payer.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Payer') }}" class="btn btn-sm btn-primary">
                                                ...
                                                @can('Edit Payer')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Payer') }}">
