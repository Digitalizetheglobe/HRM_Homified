...
@section('action-button')
    <a href="{{ route('meeting.calender') }}" class="btn btn-sm btn-primary">
        <i class="ti ti-calendar"></i>
    </a>

    @can('Create Branch')
        <a href="#" data-url="{{ route('meeting.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create New Meeting') }}" data-size="lg"
                                                ...
                                                @can('Edit Meeting')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-size="lg" data-title="{{ __('Edit Meeting') }}">
