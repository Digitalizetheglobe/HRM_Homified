...
@section('action-button')
    ...
    @can('Create Award')
        <a href="#" data-url="{{ route('award.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Award') }}" data-size="lg" class="btn btn-sm btn-primary">
                    ...
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            @foreach ($awards as $award)
                                <tr>
                                    @role('company')
                                        <td>{{ !empty($award->employee_id) ? $award->employee->full_name : '' }}</td>
                                    @endrole
                                                ...
                                                @can('Edit Award')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-size="lg"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Award') }}">
