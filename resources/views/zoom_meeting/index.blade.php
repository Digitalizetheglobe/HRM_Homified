...
@section('action-button')
    <a href="{{ route('zoom_meeting.calender') }}" class="btn btn-sm btn-primary">
        <i class="ti ti-calendar"></i>
    </a>
    @can('Create Zoom meeting')
        <a href="#" data-url="{{ route('zoom-meeting.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create New Zoom Meeting') }}" data-size="lg"
                                                ...
                                                @can('Show Zoom meeting')
                                                    <div class="action-btn bg-warning ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-size="sm" data-title="{{ __('Show Zoom Meeting Details') }}">
