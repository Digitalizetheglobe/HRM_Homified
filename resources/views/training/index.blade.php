...
@section('action-button')
    <a href="{{ route('training.export') }}" class="btn btn-sm btn-primary">
    ...
    @can('Create Training')
        <a href="#" data-url="{{ route('training.create') }}" data-ajax-popup="true" data-size="lg"
            data-title="{{ __('Create New Training') }}" class="btn btn-sm btn-primary">
                                                ...
                                                @can('Show Training')
                                                    <div class="action-btn bg-warning ms-2">
                                                        <a href="{{ route('training.show', \Illuminate\Support\Facades\Crypt::encrypt($training->id)) }}" class="mx-3 btn btn-sm  align-items-center" data-size="lg"
                                                            data-url=""
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Show Trainer') }}">
                                                ...
                                                @can('Edit Training')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-size="lg"
                                                            ...
                                                            data-ajax-popup="true" data-size="md" data-title="{{ __('Edit Training') }}">
