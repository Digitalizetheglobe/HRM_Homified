    ...
    <div class="row align-items-center m-1">
        ...
        @if ($currantLang != (!empty($settings['default_language']) ? $settings['default_language'] : 'en'))
            <div class="form-check form-switch custom-switch-v1 col-auto pe-0">
                ...
                <input type="checkbox" class="form-check-input input-primary" name="disable_lang" id="disable_lang"
        ...
        @if ($currantLang != \App\Models\Utility::settings()['default_language'])
            <div class="col-auto pe-0">
                ...
                <a href="#" class="btn btn-sm btn-danger btn-icon bs-pass-para" aria-label="Delete"><i
