    ...
    @can('Create Plan')
        @if (
            ...
            <a href="#" data-url="{{ route('plans.create') }}" data-size="md" data-ajax-popup="true"
                data-title="{{ __('Create New Plan') }}" class="btn btn-sm btn-primary">
                            ...
                            @can('Edit Plan')
                                <div class="action-btn bg-primary ms-2">
                                    <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                        ...
                                        data-url="{{ route('plans.edit', $plan->id) }}" data-size="lg"><span
                                            ...
                                            @if ($plan->price > 0 && \Auth::user()->trial_plan == 0 && \Auth::user()->plan != $plan->id && $plan->trial == 1)
                                                <div class="col-6">
                                                    <a href="{{ route('plans.trial', \Illuminate\Support\Facades\Crypt::encrypt($plan->id)) }}"
                                                        ...
                                                        data-title="{{ __('Start Free Trial') }}">{{ __('Start Free Trial') }}
                                                    </a>
                                                </div>
                                            @endif
                                            @if ($plan->price > 0)
                                                <div class="col-4">
                                                    <div class="d-grid text-center">
                                                        <a href="{{ route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($plan->id)) }}"
                                                            class="btn btn-lg btn-primary btn-icon m-1">{{ __('Subscribe') }}</a>
                                                    </div>
                                                </div>
                                            @endif
                                        @endif
