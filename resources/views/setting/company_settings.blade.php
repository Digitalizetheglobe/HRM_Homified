                    ...
                    <div class="" id="ip-restriction-settings">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <a data-url="{{ route('create.ip') }}" class="btn btn-sm btn-primary" data-size="md" data-ajax-popup="true"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            {{ Form::text('twilio_from', isset($settings['twilio_from']) ? $settings['twilio_from'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Twilio From (for SMS)')]) }}
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            {{ Form::label('Messaging Service SID', __('Messaging Service SID'), ['class' => 'col-form-label']) }}
                                            {{ Form::text('twilio_messaging_service_sid', isset($settings['twilio_messaging_service_sid']) ? $settings['twilio_messaging_service_sid'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Messaging Service SID (Required for WhatsApp)')]) }}
                                            <small class="text-muted">{{ __('Required for production WhatsApp. Find it in Twilio Console > Messaging > Services') }}</small>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            {{ Form::label('WhatsApp Content SID', __('WhatsApp Content SID (Template)'), ['class' => 'col-form-label']) }}
                                            {{ Form::text('twilio_whatsapp_content_sid', isset($settings['twilio_whatsapp_content_sid']) ? $settings['twilio_whatsapp_content_sid'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Content SID (Approved Template)')]) }}
                                            <small class="text-muted">{{ __('Required for production WhatsApp. This is your approved template Content SID from Twilio Content API') }}</small>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                                            {{-- {{ Form::label('Module Setting', __('Module Setting'), ['class' => 'col-form-label']) }} --}}
                                        </div>
                    ...
                    <div class="" id="webhook-settings">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                @can('Create Webhook')
                                    <a data-url="{{ route('create.webhook') }}" class="btn btn-sm btn-primary" data-size="md" data-ajax-popup="true"
                                                        ...
                                                        @can('Edit Webhook')
                                                            <div class="action-btn bg-info ms-2">
                                                                <a class="mx-3 btn btn-sm  align-items-center"
                                                                    ...
                                                                    data-size="md" data-ajax-popup="true"
                                                                    data-title="{{ __('Edit Webhook Settings') }}" class="edit-icon"
                                                                    data-original-title="{{ __('Edit') }}"><i
                                                                        class="ti ti-pencil text-white"></i></a>
                                                            </div>
                                                        @endcan
