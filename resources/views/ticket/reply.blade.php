...
@section('action-button')
    @if (\Auth::user()->type == 'company' || Gate::check('ticket.manage.edit.all') || (Gate::check('ticket.manage.edit.own') && ($ticket->ticket_created == \Auth::user()->id || $ticket->employee_id == \Auth::user()->id)))
        <div class="float-end">
