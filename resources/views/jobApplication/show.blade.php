                            ...
                            <ul class="list-inline mb-0">
                                @can('Delete Job Application')
                                    <li class="list-inline-item">
                                        ...
                                        <a href="#" class="bs-pass-para" aria-label="Delete">
                                    ...
                                    @if ($jobApplication->is_archive == 0)
                                        <li class="list-inline-item">
                                            ...
                                            <a href="#" class="bs-pass-para" aria-label="Delete"><span
                ...
                <div class="card-body">
                    ...
                    <h5 class="h4">
                        <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                            data-title="2 hrs ago" data-original-title="">
                            <div>
                                @php
            ...
            <div class="card">
                ...
                <div class="card-header">
                        ...
                        <dd class="col-sm-8">
                            ...
                            @if (!empty($jobApplication->resume))
                                <span class="text-sm action-btn bg-primary ms-2">
                                    <a href="{{ $resumes . '/' . $jobApplication->resume }}" download=""><i
                    ...
                    <div class='rating-stars text-right'>
                        <ul id='stars'>
                            <li class='star {{ in_array($jobApplication->rating, [1, 2, 3, 4, 5]) == true ? 'selected' : '' }}' data-value='1'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [2, 3, 4, 5]) == true ? 'selected' : '' }}' data-bs-original-title='Fair' data-value='2'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [3, 4, 5]) == true ? 'selected' : '' }}' data-bs-original-title='Good' data-value='3'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [4, 5]) == true ? 'selected' : '' }}' data-bs-original-title='Excellent' data-value='4'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [5]) == true ? 'selected' : '' }}' data-bs-original-title='WOW!!!' data-value='5'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                        </ul>
                    </div>
