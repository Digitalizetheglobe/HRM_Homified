...
@section('action-button')
    ...
    @can('Create Interview Schedule')
        <a href="#" data-url="{{ route('job.on.board.create', 0) }}" data-ajax-popup="true"
            data-title="{{ __('Create New Job On-Boarding') }}" class="btn btn-sm btn-primary">
                                        ...
                                        <span>
                                            ...
                                            @if ($job->status == 'confirm' )
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="{{route('offerlatter.download.pdf',$job->id)}}" class="mx-3 btn btn-sm  align-items-center " target="_blanks"><i class="ti ti-download text-white"></i></a>
                                                </div>
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="{{route('offerlatter.download.doc',$job->id)}}" class="mx-3 btn btn-sm  align-items-center " target="_blanks"><i class="ti ti-download text-white"></i></a>
                                                </div>
                                            @endif
                                        </span>
                                    </td>
