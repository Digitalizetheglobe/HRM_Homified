...
<div class="container mx-auto p-4">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('booking.add')); ?>">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="project_id" id="projectFilter" class="form-control select2" required>
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($id); ?>" <?php echo e(request('project_id') == $id ? 'selected' : ''); ?>>
                                    <?php echo e($name); ?>
                    ...
                    <div class="form-group col-md-6">
                        <?php echo e(Form::label('enquiry_id', __('Enquiry'), ['class' => 'col-form-label'])); ?>

                        <select name="enquiry_id" id="enquiryFilter" class="form-control " 
                            <?php echo e(!request('project_id') ? 'disabled' : ''); ?> required>
                            ...
                            <?php $__currentLoopData = $enquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($enquiry->id); ?>" <?php echo e(request('enquiry_id') == $enquiry->id ? 'selected' : ''); ?>>
                                    <?php echo e($enquiry->full_name); ?> (<?php echo e($enquiry->mobile_no); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-end gap-2 booking-buttons-mobile">
                            ...
                            <a href="<?php echo e(route('booking.add')); ?>" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <?php if($selectedEnquiry): ?>
        ...
        <div class="card">
            <div class="card-header text-center">
                <h4>Booking Form for <?php echo e($selectedEnquiry->full_name); ?></h4>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo e(Form::hidden('enquiry_id', $selectedEnquiry->id)); ?>
                ...
                <div class="row p-3 mb-3">
                    <div class="form-group col-md-4">
                        <?php echo e(Form::label('primary_applicant_name', __('Full Name'), ['class' => 'col-form-label'])); ?>
                        ...
                        <?php if($errors->has('primary_applicant_name')): ?>
                            <div class="invalid-feedback">
                                <?php echo e($errors->first('primary_applicant_name')); ?>

                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="form-group col-md-4">
                        <?php echo e(Form::label('primary_applicant_contact_no', __('Contact No.'), ['class' => 'col-form-label'])); ?>
                    ...
                    <div class="form-group col-md-4">
                        <?php echo e(Form::label('primary_applicant_email', __('Email'), ['class' => 'col-form-label'])); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('primary_applicant_pan_no', $bookingForm->primary_applicant_pan_no ?? '', ['class' => 'form-control pan-input', 'placeholder' => 'Enter PAN No', 'style' => 'text-transform: uppercase', 'maxlength' => '10'])); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('primary_applicant_aadhar_no', $bookingForm->primary_applicant_aadhar_no ?? '', ['class' => 'form-control aadhar-input', 'placeholder' => 'Enter Aadhar No (12 digits)', 'maxlength' => '12', 'pattern' => '[0-9]{12}', 'inputmode' => 'numeric', 'type' => 'tel', 'onkeypress' => 'return event.charCode >= 48 && event.charCode <= 57'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('secondary_applicant_pan_no', $bookingForm->secondary_applicant_pan_no ?? '', ['class' => 'form-control pan-input', 'placeholder' => 'Enter PAN No.', 'style' => 'text-transform: uppercase', 'maxlength' => '10'])); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('secondary_applicant_aadhar_no', $bookingForm->secondary_applicant_aadhar_no ?? '', ['class' => 'form-control aadhar-input', 'placeholder' => 'Enter Aadhar No (12 digits)', 'maxlength' => '12', 'pattern' => '[0-9]{12}', 'inputmode' => 'numeric', 'type' => 'tel', 'onkeypress' => 'return event.charCode >= 48 && event.charCode <= 57'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="project_id" id="projectDropdown" class="form-control select2" required disabled>
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($id); ?>" <?php echo e(request('project_id') == $id ? 'selected' : ''); ?> 
                                        data-type="<?php echo e($projectTypes[$id] ?? ''); ?>">
                                    <?php echo e($name); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php echo e(Form::hidden('project_type', $projectType ?? '', ['id' => 'project_type'])); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="unit_id" id="unitDropdown" class="form-control" required>
                            ...
                            <?php if(request('project_id') && $units): ?>
                                <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($unit->id); ?>" 
                                        data-size="<?php echo e($unit->unit_size); ?>"
                                        <?php echo e($bookingForm->unit_id == $unit->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('unit_size', $bookingForm->unit_size ?? '', [
                            'class' => 'form-control',
                            'id' => 'unit_size',
                            'readonly' => true
                        ])); ?>
                    ...
                    <?php if($projectType == 1 || $projectType == 2): ?> 
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('carpet_area', $bookingForm->carpet_area ?? '', [
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            <?php echo e(Form::label('built_up_area', __('Built Up Area (sq.ft)'), ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::text('built_up_area', $bookingForm->built_up_area ?? '', [
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('rate_per_sq_ft', $bookingForm->rate_per_sq_ft ?? '', [
                                'class' => 'form-control residential-commercial-input',
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('cost_infrastructure', $bookingForm->cost_infrastructure ?? '', [
                                'class' => 'form-control residential-commercial-input',
                        ...
                        <!-- Agreement Cost -->
                        <div class="form-group col-md-4 residential-commercial-field">
                            <?php echo e(Form::label('agreement_cost', __('Total Agreement Cost (Rs)'), ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::text('agreement_cost', $bookingForm->agreement_cost ?? '', [
                                'class' => 'form-control residential-commercial-result',
                                'readonly' => true
                            ])); ?>
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('gst', $bookingForm->gst ?? '', [
                                'class' => 'form-control residential-commercial-result',
                                'readonly' => false
                            ])); ?>
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('stamp_duty', $bookingForm->stamp_duty ?? '', [
                                'class' => 'form-control residential-commercial-result',
                                'readonly' => true
                            ])); ?>
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('registration', $bookingForm->registration ?? '', [
                                'class' => 'form-control residential-commercial-result',
                                'readonly' => false
                            ])); ?>
                        ...
                        <!-- Legal Charges -->
                        <div class="form-group col-md-4 residential-commercial-field">
                            <?php echo e(Form::label('legal_charges', __('Legal Charges (Rs)'), ['class' => 'col-form-label'])); ?>

                            <?php echo e(Form::text('legal_charges', $bookingForm->legal_charges ?? '', [
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('other', $bookingForm->other ?? '', [
                                'class' => 'form-control residential-commercial-optional',
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('maintenance_cost', $bookingForm->maintenance_cost ?? '', [
                                'class' => 'form-control residential-commercial-optional',
                        ...
                        <div class="form-group col-md-4 residential-commercial-field">
                            ...
                            <?php echo e(Form::text('total_cost', $bookingForm->total_cost ?? '', [
                                'class' => 'form-control residential-commercial-result',
                                'readonly' => true
                            ])); ?>
                    ...
                    <?php if($projectType == 3): ?> 
                        ...
                        <div class="form-group col-md-4 plotting-field">
                            ...
                            <?php echo e(Form::text('plot_area', $bookingForm->plot_area ?? '', [
                        ...
                        <div class="form-group col-md-4 plotting-field">
                            ...
                            <?php echo e(Form::text('basic_cost', $bookingForm->basic_cost ?? '', [
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <?php echo e(Form::label('payment_total_cost', __('Total Cost (Rs)'), ['class' => 'col-form-label'])); ?>

                        <?php echo e(Form::text('payment_total_cost', '', [
                            'class' => 'form-control', 
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('remaining', '', [
                            'class' => 'form-control', 
                            'id' => 'remaining', 
                            'readonly' => true
                        ])); ?>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <?php echo e(Form::text('total_paid', '0', [
                            'class' => 'form-control', 
                            'id' => 'total_paid', 
                            'readonly' => true
                        ])); ?>
...
<script>
    $(document).ready(function() {
        ...
        <?php if(request('project_id')): ?>
            ...
            <?php if(isset($projectType)): ?>
                handleProjectType(<?php echo e($projectType); ?>);
            <?php endif; ?>
        <?php endif; ?>
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        ...
                        window.location.href = '<?php echo e(route("booking.all")); ?>';
                    });
                },
                error: function(xhr) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/booking/addbooking.blade.php ENDPATH**/ ?>