        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <h5><?php echo e(__('Salary Processing')); ?></h5>
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        <div class="btn-box" style="min-width: 120px;">
                            <?php echo e(Form::label('month', __('Month'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::select('month', $month, date('m'), ['class' => 'form-control month_date', 'placeholder' => __('Select Month')])); ?>
                        ...
                        <div class="btn-box" style="min-width: 150px;">
                            ...
                            <?php echo e(Form::select('department_id', $departments, '', ['class' => 'form-control department_filter', 'placeholder' => __('All Departments')])); ?>
                        ...
                        <div class="btn-box align-self-end">
                            ...
                            <button type="submit" class="btn btn-primary" id="export_btn">
                                <i class="ti ti-file-export"></i> <?php echo e(__('Export')); ?>
            ...
            <div class="card-body table-border-style">
                <table class="table" id="pc-dt-render-column-cells">
                        <thead>
                            <tr>
                                <th rowspan="2"><?php echo e(__('Employee Code')); ?></th>
                                <th rowspan="2"><?php echo e(__('Employee Name')); ?></th>
                                <th rowspan="2"><?php echo e(__('Monthly Days')); ?></th>
                                <th rowspan="2"><?php echo e(__('Payable Days')); ?></th>
                                <th rowspan="2"><?php echo e(__('Total Leave')); ?></th>
                                <th rowspan="2"><?php echo e(__('Actual Salary')); ?></th>
                                <th rowspan="2"><?php echo e(__('Monthly Salary')); ?></th>
                                <th colspan="5" style="text-align: center; background-color: #e3f2fd;"><?php echo e(__('Monthly Salary Breakdown')); ?></th>
                                <th rowspan="2"><?php echo e(__('Salary Arrears')); ?></th>
                                <th rowspan="2"><?php echo e(__('Petrol Allowance')); ?></th>
                                <th rowspan="2"><?php echo e(__('Gross Salary')); ?></th>
                                <th colspan="5" style="text-align: center; background-color: #fff3e0;"><?php echo e(__('Deductions')); ?></th>
                                <th rowspan="2"><?php echo e(__('Net Amount Payable')); ?></th>
                                <th rowspan="2"><?php echo e(__('Final Salary')); ?></th>
                                <th rowspan="2"><?php echo e(__('Status')); ?></th>
                            </tr>
                            <tr>
                                <th style="background-color: #e3f2fd;"><?php echo e(__('Basic Pay')); ?><br><small>(41%)</small></th>
                                <th style="background-color: #e3f2fd;"><?php echo e(__('HRA')); ?><br><small>(25%)</small></th>
                                <th style="background-color: #e3f2fd;"><?php echo e(__('Conveyance')); ?><br><small>(21%)</small></th>
                                <th style="background-color: #e3f2fd;"><?php echo e(__('Special Allowance')); ?><br><small>(10%)</small></th>
                                <th style="background-color: #e3f2fd;"><?php echo e(__('Medical')); ?><br><small>(3%)</small></th>
                                <th style="background-color: #fff3e0;"><?php echo e(__('LOP Days')); ?></th>
                                <th style="background-color: #fff3e0;"><?php echo e(__('LOP Amount')); ?></th>
                                <th style="background-color: #fff3e0;"><?php echo e(__('PT')); ?><br><small>(₹200)</small></th>
                                <th style="background-color: #fff3e0;"><?php echo e(__('Salary Advance')); ?></th>
                                <th style="background-color: #fff3e0;"><?php echo e(__('Other Deductions')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/payslip/salary-processing.blade.php ENDPATH**/ ?>