...
<div class="modal-body px-50">
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::email('email_id', '', ['class' => 'form-control', 'placeholder' => 'Enter email ID'])); ?>
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::date('follow_up_date', '', ['class' => 'form-control', 'placeholder' => 'Select follow up date'])); ?>
...
$('#choices-multiple').on('change', function() {
    ...
    $.ajax({
        url: "<?php echo e(url('get-employee-projects')); ?>/" + userId,
        type: 'GET',
...
$(document).ready(function() {
    ...
    $('#projectDropdown').on('change', function() {
        ...
        const currentUserId = "<?php echo e(Auth::id()); ?>"; // Get current user ID
...
</script><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/timeSheet/create.blade.php ENDPATH**/ ?>