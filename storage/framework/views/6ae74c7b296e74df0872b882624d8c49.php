...
<body>
    <div class="login-container">
        ...
        <div class="login-form">
            <div class="logo">
                <img src="<?php echo e(asset('storage/uploads/logo/logo.png')); ?>" alt="Logo">
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="display: flex; gap: 15px;">
                    ...
                    <button type="submit" class="btn" style="flex: 1;"><?php echo e(__('Login')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/auth/login.blade.php ENDPATH**/ ?>