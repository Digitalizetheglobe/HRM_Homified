...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            lockDropdown('#department_id', '<?php echo e(__("Select Branch first")); ?>');
            lockDropdown('#employee_id',   '<?php echo e(__("Select Department first")); ?>');

            // --- PRE-SELECT FROM URL PARAMS ---
            var urlBranch     = '<?php echo e(isset($_GET["branch"])     ? $_GET["branch"]     : ""); ?>';
            var urlDepartment = '<?php echo e(isset($_GET["department"]) ? $_GET["department"] : ""); ?>';
            var urlEmployee   = '<?php echo e(isset($_GET["employee"])   ? $_GET["employee"]   : ""); ?>';
        ...
        function getDepartments(branchId, preselectDept, preselectEmp) {
            ...
            $select.html('<option value=""><?php echo e(__("Loading...")); ?></option>').prop('disabled', true);
            ...
            $.ajax({
                ...
                success: function (data) {
                    var html = '<option value=""><?php echo e(__("All Departments")); ?></option>';
                ...
                error: function () {
                    lockDropdown('#department_id', '<?php echo e(__("Error loading departments")); ?>');
                }
            });
        }
        ...
        function getEmployees(deptId, preselectEmp) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var html = '<option value=""><?php echo e(__("All Employees")); ?></option>';
                    $.each(data, function (key, value) {
                ...
                error: function () {
                    lockDropdown('#employee_id', '<?php echo e(__("Error loading employees")); ?>');
                }
            });
        }
    </script>
                    ...
                    <div class="card-body py-3 px-4">
                        ...
                        <div class="filter-row mb-3 pb-3" style="border-bottom: 1px solid #eef0f6; justify-content: flex-end;">
                            <div class="filter-group" style="max-width:200px;">
                                ...
                                <div class="d-flex gap-3 pt-1">
                                    <div class="form-check mb-0">
                                        ...
                                        <label class="form-check-label" for="daily" style="text-transform:none;font-size:13px;color:#3a3f5a;"><?php echo e(__('Daily')); ?></label>
                                    </div>
                                    <div class="form-check mb-0">
                                        ...
                                        <label class="form-check-label" for="monthly" style="text-transform:none;font-size:13px;color:#3a3f5a;"><?php echo e(__('Monthly')); ?></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="filter-group month" style="max-width:200px;">
                                ...
                                <?php echo e(Form::month('month', isset($_GET['month']) ? $_GET['month'] : date('Y-m'), ['class' => 'form-control', 'style' => 'padding:8px 12px;border:1.5px solid #dde3ef;border-radius:8px;font-size:13.5px;'])); ?>

                            </div>
                            <div class="filter-group date d-none" style="max-width:200px;">
                                <label><?php echo e(__('Date')); ?></label>
                                <?php echo e(Form::date('date', isset($_GET['date']) ? $_GET['date'] : '', ['class' => 'form-control', 'style' => 'padding:8px 12px;border:1.5px solid #dde3ef;border-radius:8px;font-size:13.5px;'])); ?>

                            </div>

                            <?php if(!(\Auth::user()->type != 'employee' || ($isHR && !request()->has('own')))): ?>
                            
                            <div class="filter-actions">
                                <button type="submit" class="btn btn-sm btn-primary" title="<?php echo e(__('Search')); ?>" style="height:37px;width:37px;padding:0;border-radius:8px;">
                                    <i class="ti ti-search"></i>
                                </button>
                                <a href="<?php echo e(route('attendanceemployee.index')); ?>" class="btn btn-sm btn-danger" title="<?php echo e(__('Reset')); ?>" style="height:37px;width:37px;padding:0;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;">
                        ...
                        <div class="filter-row align-items-end flex-wrap" style="justify-content: flex-end;">
                            ...
                            <div class="filter-group">
                                ...
                                <div class="filter-select-wrap">
                                    <?php echo e(Form::select('branch', $branch, isset($_GET['branch']) ? $_GET['branch'] : '', ['class' => 'form-control', 'id' => 'branch_id', 'style' => 'padding:8px 32px 8px 12px;border:1.5px solid #dde3ef;border-radius:8px;font-size:13.5px;'])); ?>
                            ...
                            <div class="filter-group">
                                ...
                                <div class="filter-select-wrap" id="dept-select-wrap">
                                    <select name="department" id="department_id" class="form-control" style="padding:8px 32px 8px 12px;border:1.5px solid #dde3ef;border-radius:8px;font-size:13.5px;" disabled>
                                        <option value=""><?php echo e(__('Select Branch first')); ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="filter-group">
                                ...
                                <div class="filter-select-wrap" id="emp-select-wrap">
                                    <select name="employee" id="employee_id" class="form-control" style="padding:8px 32px 8px 12px;border:1.5px solid #dde3ef;border-radius:8px;font-size:13.5px;" disabled>
                                        <option value=""><?php echo e(__('Select Department first')); ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="filter-actions">
                                ...
                                <?php if(Gate::check('attendance.marked.import.all')): ?>
                                    <a href="#" data-url="<?php echo e(route('attendance.file.import')); ?>"
                                        ...
                                        class="btn btn-sm btn-primary" title="<?php echo e(__('Import')); ?>" style="height:37px;width:37px;padding:0;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;">
                                        <i class="ti ti-file"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(Gate::check('attendance.marked.export.all')): ?>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#exportAttendanceModal"
                                        class="btn btn-sm btn-primary" title="<?php echo e(__('Export')); ?>" style="height:37px;width:37px;padding:0;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;">
                        ...
                        <table class="table" id="pc-dt-simple">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start"><?php echo e(__('Clock-In Time')); ?></th>
                                    <th class="text-start"><?php echo e(__('Late')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-In Location')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-In 2')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-In 2 Location')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-Out Time')); ?></th>
                                    <th class="text-start"><?php echo e(__('Early Leaving')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-Out Location')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-Out 2')); ?></th>
                                    <th class="text-start"><?php echo e(__('Clock-Out 2 Location')); ?></th>
                                    <?php if(Gate::check('attendance.marked.edit.all') || Gate::check('attendance.marked.delete.all')): ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $attendanceEmployee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if(\Auth::user()->type != 'employee' || ($isHR && !request()->has('own'))): ?>
                                            <td class="text-start"><?php echo e(!empty($attendance->employee) ? $attendance->employee->full_name : ''); ?></td>
                                        <?php endif; ?>
                                        <td class="text-start"><?php echo e(\Auth::user()->dateFormat($attendance->date)); ?></td>
                                        <td class="text-start">
                                            <?php if(($attendance->clock_out == '00:00:00' || empty($attendance->clock_out)) && !empty($attendance->clock_in) && $attendance->clock_in != '00:00:00'): ?>
                                                <span class="badge bg-info"><?php echo e(__('Single Punch In')); ?></span>
                                            <?php else: ?>
                                                <?php echo e($attendance->status); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td class="text-start"><?php echo e($attendance->clock_in != '00:00:00' ? \Auth::user()->timeFormat($attendance->clock_in) : '00:00'); ?>

                                        </td>
                                        <td class="text-start">
                                            <?php if($attendance->late != '00:00:00'): ?>
                                                <span class="badge bg-danger"><?php echo e($attendance->late); ?> <?php echo e(__('Late')); ?></span>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-start"><?php echo breakAfterWords($attendance->clock_in_location); ?></td>
                                        <td class="text-start"><?php echo e($attendance->clock_in_2 != '00:00:00' && !empty($attendance->clock_in_2) ? \Auth::user()->timeFormat($attendance->clock_in_2) : '-'); ?></td>
                                        <td class="text-start"><?php echo breakAfterWords($attendance->clock_in_2_location); ?></td>
                                        <td class="text-start"><?php echo e($attendance->clock_out != '00:00:00' ? \Auth::user()->timeFormat($attendance->clock_out) : '00:00'); ?>

                                        </td>
                                        <td class="text-start">
                                            <?php if($attendance->early_leaving != '00:00:00'): ?>
                                                <span class="badge bg-danger"><?php echo e($attendance->early_leaving); ?> <?php echo e(__('Early Leaving')); ?></span>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-start"><?php echo breakAfterWords($attendance->clock_out_location); ?></td>
                                        <td class="text-start"><?php echo e($attendance->clock_out_2 != '00:00:00' && !empty($attendance->clock_out_2) ? \Auth::user()->timeFormat($attendance->clock_out_2) : '-'); ?></td>
                                        <td class="text-start"><?php echo breakAfterWords($attendance->clock_out_2_location); ?></td>
                                        <?php if(Gate::check('attendance.marked.edit.all') || Gate::check('attendance.marked.delete.all')): ?>
                                            <td class="Action" style="vertical-align: middle;">
                                                <span class="d-flex align-items-center justify-content-center">
                                                    <?php if(Gate::check('attendance.marked.edit.all')): ?>
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="#" class="btn btn-sm d-flex align-items-center justify-content-center"
                                                                ...
                                                                data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Edit Attendance')); ?>"
                                                    ...
                                                    <?php if(Gate::check('attendance.marked.delete.all')): ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="exportAttendanceModalLabel"><?php echo e(__('Advanced Attendance Export')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?php echo e(route('attendance.export')); ?>" method="GET" id="exportAttendanceForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label for="export_year" class="form-label font-weight-bold"><?php echo e(__('Select Year')); ?></label>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label font-weight-bold d-block"><?php echo e(__('Export Mode')); ?></label>
                            <div class="d-flex gap-3 pt-1">
                                <div class="form-check">
                                    <input type="radio" id="mode_range" name="export_mode" value="range" class="form-check-input" checked>
                                    <label class="form-check-label" for="mode_range" style="font-size: 13.5px; color: #3a3f5a;"><?php echo e(__('Month Range')); ?></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="mode_specific" name="export_mode" value="specific" class="form-check-input">
                                    <label class="form-check-label" for="mode_specific" style="font-size: 13.5px; color: #3a3f5a;"><?php echo e(__('Selected Months')); ?></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="mode_daily" name="export_mode" value="daily" class="form-check-input">
                                    <label class="form-check-label" for="mode_daily" style="font-size: 13.5px; color: #3a3f5a;"><?php echo e(__('Single Date (Daily)')); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="daily_mode_wrapper" class="form-group mb-3 d-none">
                            <label for="export_date" class="form-label font-weight-bold"><?php echo e(__('Select Date')); ?></label>
                            <input type="date" name="export_date" id="export_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                        </div>

                        <!-- Mode: Month Range -->
                        <div id="range_mode_wrapper" class="row">
                            <div class="col-6 form-group">
                                <label for="start_month" class="form-label"><?php echo e(__('From Month')); ?></label>
                                <select name="start_month" id="start_month" class="form-control">
                                    <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m); ?>" <?php echo e($m == date('n') ? 'selected' : ''); ?>><?php echo e(date('F', mktime(0, 0, 0, $m, 1))); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-6 form-group">
                                <label for="end_month" class="form-label"><?php echo e(__('To Month')); ?></label>
                        ...
                        <div id="specific_mode_wrapper" class="form-group mb-3 d-none">
                            <label class="form-label d-block"><?php echo e(__('Select Months')); ?></label>
                            <div class="row pt-1">
                                <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-4 mb-2">
                                        <div class="form-check">
                                            <input type="checkbox" name="selected_months[]" value="<?php echo e($m); ?>" id="month_<?php echo e($m); ?>" class="form-check-input select-month-cb">
                                            <label class="form-check-label" for="month_<?php echo e($m); ?>" style="font-size: 13px; color: #3a3f5a;"><?php echo e(date('M', mktime(0, 0, 0, $m, 1))); ?></label>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"><?php echo e(__('Export Excel')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/attendance/index.blade.php ENDPATH**/ ?>