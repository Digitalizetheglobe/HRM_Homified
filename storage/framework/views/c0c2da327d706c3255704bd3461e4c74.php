                    ...
                    <div class="" id="ip-restriction-settings">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <a data-url="<?php echo e(route('create.ip')); ?>" class="btn btn-sm btn-primary" data-size="md" data-ajax-popup="true"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            <?php echo e(Form::text('twilio_from', isset($settings['twilio_from']) ? $settings['twilio_from'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Twilio From (for SMS)')])); ?>

                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            <?php echo e(Form::label('Messaging Service SID', __('Messaging Service SID'), ['class' => 'col-form-label'])); ?>

                                            <?php echo e(Form::text('twilio_messaging_service_sid', isset($settings['twilio_messaging_service_sid']) ? $settings['twilio_messaging_service_sid'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Messaging Service SID (Required for WhatsApp)')])); ?>

                                            <small class="text-muted"><?php echo e(__('Required for production WhatsApp. Find it in Twilio Console > Messaging > Services')); ?></small>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            <?php echo e(Form::label('WhatsApp Content SID', __('WhatsApp Content SID (Template)'), ['class' => 'col-form-label'])); ?>

                                            <?php echo e(Form::text('twilio_whatsapp_content_sid', isset($settings['twilio_whatsapp_content_sid']) ? $settings['twilio_whatsapp_content_sid'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Content SID (Approved Template)')])); ?>

                                            <small class="text-muted"><?php echo e(__('Required for production WhatsApp. This is your approved template Content SID from Twilio Content API')); ?></small>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
...
<div class="card-body table-border-style" style="display: flow-root;">
                                        ...
                                        <div class="card-header card-body">
                                            <div class="row text-xs">
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">
                                                        <?php echo e(__('Employee First Name')); ?> :
                                                        <span class="pull-right text-primary">{employee_first_name}</span>
                                                    </p>
                                                    <p class="col-4">
                                                        <?php echo e(__('Employee Middle Name')); ?> :
                                                        <span class="pull-right text-primary">{employee_middle_name}</span>
                                                    </p>
                                                    <p class="col-4">
                                                        <?php echo e(__('Employee Last Name')); ?> :
                                                        <span class="pull-right text-primary">{employee_last_name}</span>
                                                    </p>
                                                    <p class="col-4">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Webhook')): ?>
                                    <a data-url="<?php echo e(route('create.webhook')); ?>" class="btn btn-sm btn-primary" data-size="md" data-ajax-popup="true"
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Webhook')): ?>
                                                            <div class="action-btn bg-info ms-2">
                                                                <a class="mx-3 btn btn-sm  align-items-center"
                                                                    ...
                                                                    data-size="md" data-ajax-popup="true"
                                                                    data-title="<?php echo e(__('Edit Webhook Settings')); ?>" class="edit-icon"
                                                                    data-original-title="<?php echo e(__('Edit')); ?>"><i
                                                                        class="ti ti-pencil text-white"></i></a>
                                                            </div>
                                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/setting/company_settings.blade.php ENDPATH**/ ?>