...
unset($__errorArgs, $__bag); ?> <?php echo e(\Auth::user()->type === 'employee' ? 'bg-light' : ''); ?>" name="email"
                                            type="email" id="email" placeholder="<?php echo e(__('Enter Your Email Address')); ?>"
                                            value="<?php echo e($userDetail->email); ?>" <?php echo e(\Auth::user()->type === 'employee' ? 'readonly' : 'required'); ?> autocomplete="email">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrm_realestate\resources\views/user/profile.blade.php ENDPATH**/ ?>